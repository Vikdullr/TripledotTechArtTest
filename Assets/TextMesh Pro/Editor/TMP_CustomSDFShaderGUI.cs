...
{
    public class TMP_CustomSDFShaderGUI : TMP_BaseShaderGUI
    {
        static ShaderFeature s_OutlineFeature, s_UnderlayFeature, s_BevelFeature, s_GlowFeature, s_MaskFeature;

        static bool s_Face = true, s_Outline = true, s_Outline2 = true, s_Outline3 = true, s_Underlay = true, s_Underlay2 = true, s_Lighting = true, s_Glow, s_Bevel, s_Light, s_Bump, s_Env;
        ...
        protected override void DoGUI()
        {
            ...
            if (m_Material.HasProperty("_Underlay2Color"))
            {
                s_Underlay2 = BeginPanel("Underlay 2", s_Underlay2);
                if (s_Underlay2)
                {
                    DoUnderlay2Panel();
                }
        ...
        void DoUnderlay2Panel()
        {
            EditorGUI.indentLevel += 1;
            DoColor("_Underlay2Color", "Color");
            DoSlider("_Underlay2Offset", "X", new Vector2(-1, 1), "Offset X");
            DoSlider("_Underlay2Offset", "Y", new Vector2(-1, 1), "Offset Y");
            DoSlider("_Underlay2Dilate", new Vector2(-1, 1), "Dilate");
            DoSlider("_Underlay2Softness", new Vector2(0, 1), "Softness");
            EditorGUI.indentLevel -= 1;
            EditorGUILayout.Space();
        }
